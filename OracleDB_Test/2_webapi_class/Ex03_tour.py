...
def getTourPointVistor(yyyymm, sido, gungu, nPagenum, nItems):
    ...
    queryParams += '&RES_NM=&pageNo=' + str(nPagenum)
        ...
        for month in range(1,13):
            ...
            while True:
                ...
                if jsonData['response']['header']['resultMsg'] == 'OK':
                    ...
                    break
    # with open("./data/%s_관광지입장정보_%d_%d.json", "w") as j:
    #      saveJson = json.dumps(jsonResult, indent=4, sort_keys=True, ensure_ascii=False)
    #      j.write(saveJson)


                # with open('./data/%s_관광지입장정보_%d_%d.json'&(sido, nStartYear,nEndYear), 'wb', encoding='utf-8') as f:
